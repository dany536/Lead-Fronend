...
const LeadUpdate = () => {
    ...
    return (
        <>
            <Header />
            <div className='min-h-screen bg-gradient-to-tr from-blue-100 via-white to-green-100 pt-5 lg:pt-2'>
                <Admin />
                                    ...
                                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        ...
                                        <div className="md:col-span-5">
                                            ...
                                            <select
                                                ...
                                                id="teamLeader"
                                                className="h-10 border mt-1 rounded p-2 w-full bg-gray-50"
                                            >
                                    ...
                                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        ...
                                        <div className="md:col-span-5 text-right pt-2">
                                            <div className="inline-flex items-end gap-2">
                                                ...
                                                <button type='submit' className="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">{id ? 'Update' : 'Add'} Employee</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
