...
const leaderPannel = () => {
  ...
  const fetchEmployee = async () => {
    axios.get(`${API_BASE_URL}/leaderPannel/${id}`)
  ...
  return (
    <>
      ...
      <div className='min-h-screen bg-gradient-to-tr from-blue-100 via-white to-green-100 p-4'>
        ...
        <CardDataStats title="Meeding Done" total={meetingDoneLead.length}>
          <svg
            className="fill-primary dark:fill-white"
            width="20"
            height="22"
        ...
        <section className="mx-auto w-full max-w-7xl px-4 py-4 mt-3">
          <div className="flex space-y-3 flex-row items-center justify-between md:space-y-2">
            <div>
