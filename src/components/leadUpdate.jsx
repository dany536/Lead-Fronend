                            ...
                            <div className="p-4 px-4 md:p-10 md:pt-5">
                                <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    ...
                                    <div className="md:col-span-5">
                                        ...
                                        <input type="text" name="dateOfLead" value={formatDate(lead.dateOfLead)} onChange={handleChange} id="dateOfLead" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" />
                                    </div>
                            ...
                            <div className="p-4 px-4 md:p-10 md:pt-5">
                                <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    ...
                                    <div className="md:col-span-5">
                                        ...
                                        <input type="date" name="lastAssignedDate" onChange={handleChange} id="lastAssignedDate" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" />
                                    </div>
