              ...
              <div className="p-4 px-4 md:p-10 md:pt-5">
                <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                  <div className="md:col-span-5">
                    ...
                    <input value={lead.assignedTo ? lead.assignedTo.name : 'Not Assign'} className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" disabled />
                  </div>
                  ...
                  <div className="md:col-span-5">
                    <label>Status</label>
                    <input value={lead.status ? lead.status : 'No Update'} className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" disabled />
                  </div>

                  <div className="md:col-span-5">
                    <label for="data_source">Remarks</label>
                    <textarea rows="6" value={lead.remark} className="border mt-1 rounded p-3 w-full bg-gray-50" disabled></textarea>
                  </div>
