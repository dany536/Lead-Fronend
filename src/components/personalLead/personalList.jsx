    ...
    <>
      ...
      <div className='min-h-screen bg-gradient-to-tr from-blue-100 via-white to-green-100 p-4'>
        <section className="mx-auto w-full max-w-7xl md:px-4 md:py-4 md:mt-3">
          <div className="flex space-y-2 flex-col md:flex-row items-center justify-between md:space-y-0">
            <div>
            ...
            <div className='flex flex-row gap-5'>
              <Link
                ...
                className="rounded-md bg-gray-500 px-10 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
              >
                Switch to Official
              </Link>
              <Link
